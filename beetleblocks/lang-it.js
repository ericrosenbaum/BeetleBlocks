...
*/
    ...
    'language_translator':
        'Stefano Federici, Alberto Firpo, Massimo Ghisalberti, Riccardo Lussu', // your name for the Translators tab
    'translator_e-mail':
        's_federici@yahoo.com, albertofirpo12@gmail.com, zairik@gmail.com, riclussu@gmail.com', // optional
    'last_changed':
        '2018-8-7', // this, too, will appear in the Translators tab
   ...
   'split %s by %delim':
	...
	'Set grid interval':
		'Imposta intervallo della griglia',
	'Set grid color':
		'Imposta colore della griglia',
	'Turbo mode':
		'Modalit\u00E0 turbo',
	'Beetle':
		'Coccinella',
	...
	'move %n':
		'fai %n passi',
	'rotate %axes by %n':
		'ruota asse %axes di %n gradi',
	'go to x: %n y: %n z: %n':
		'vai a x: %n y: %n z: %n',
	'set %axes to %n':
		'porta asse %axes a %n',
	'change absolute %axes by %n':
		'muovi lungo l\'asse %axes di %n',
	'set %axes rotation to %n':
		'imposta rotazione asse %axes a %n',
	...
	*/
	...
	'cube Dim. %n':
		'cubo dim. %n',
	'cuboid l: %n w: %n h: %n':
		'cuboide lung. %n larg. %n alt. %n',
	'sphere Dia. %n':
		'sfera Diam. %n',
	'tube l: %n outer: %n inner: %n':
		'tubo lung. %n larg: %n alt: %n',
	'text %s H: %n W: %n':
		'testo %s alt. %n larg. %n',
	'hello':
		'ciao',
	'2D text %s size: %n':
	...
	'set extrusion Dia. to %n':
		'imposta Diam. estrusione a %n',
	'change extrusion Dia. by %n':
		'cambia Diam. estrusione di %n',
